...
/* package ttt-0.1.0.0 */
#ifndef VERSION_ttt
#define VERSION_ttt "0.1.0.0"
#endif /* VERSION_ttt */
#ifndef MIN_VERSION_ttt
#define MIN_VERSION_ttt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ttt */
...
#define CURRENT_COMPONENT_ID "ttt-0.1.0.0-inplace-ttt"
